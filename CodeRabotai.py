...
from openai import OpenAIError, APIError, BadRequestError  # Используем правильные исключения
...
async def handle_message(update: Update, context):
    ...
    # Обработка исключений OpenAI
        ...
        await update.message.reply_text(f'Произошла ошибка при получении ответа: {str(e)}')
