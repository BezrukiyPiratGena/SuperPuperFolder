...
DOCX_DIRECTORY = r"C:\Project1\GITProjects\Мануалы\АИС КТМ-201"  # <================= Путь к файлам docx
count_collection = 10  # <====================================================================================== Номер коллекции в Milvus

end_file = ".docx"  # <============================================================================================ Окончание файла коллекции в Milvus
...
def process_content_from_word(word_path, name_of_bucket_minio):
    ...
    text_blocks_with_refs, full_text = extract_content_from_word(
        word_path, name_of_bucket_minio
    )
...
for docx_file in docx_files:
    ...
    # Описание коллекции
    description_milvus_collection = name_documents + end_file  # <= Смени названик
