...
csv_file = r"C:\Project1\Документы для обучения GPT\Тестовые данные\table_62.csv"
xlsx_file = r"C:\Project1\Документы для обучения GPT\Тестовые данные\table_62.xlsx"
